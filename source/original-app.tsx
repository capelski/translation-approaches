...
export interface OriginalAppProps {
  defaultLanguage: string;
}

export const OriginalApp: React.FC<OriginalAppProps> = (props: OriginalAppProps) => {
  ...
  return (
    <div>
      <h1>Hello World</h1>
      <p>
        <b>Some long text that we want translated</b>: Contrary to popular belief, Lorem Ipsum is
